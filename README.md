...
- 目前套件與 SHA256：[`OpenWrt Release`](https://github.com/alzpqm/Natter/releases/tag/openwrt-2.2.1-r13)

Release 內含：

- `natter-2.2.1-r13.apk`
- `luci-app-natter-2.2.1-r13.apk`
- `natter_2.2.1-r13_all.ipk`（OpenWrt 22.03）
- `luci-app-natter_2.2.1-r13_all.ipk`（OpenWrt 22.03）
